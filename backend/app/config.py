...
def get_settings() -> Settings:
    return Settings(
        ...
        supabase_url=_get_env_value("SUPABASE_URL") or _get_env_value("NEXT_PUBLIC_SUPABASE_URL") or "",
        supabase_service_role_key=_get_env_value("SUPABASE_SERVICE_ROLE_KEY") or "",
        supabase_jwt_secret=_get_env_value("SUPABASE_JWT_SECRET") or "",
        opencode_go_api_key=_get_env_value("OPENCODE_GO_API_KEY") or "",
        opencode_go_base_url=_get_env_value("OPENCODE_GO_BASE_URL") or "https://api.opencode.ai/v1",
        opencode_zen_api_key=_get_env_value("OPENCODE_ZEN_API_KEY") or "",
        opencode_zen_base_url=_get_env_value("OPENCODE_ZEN_BASE_URL") or "https://api.opencode.ai/v1",
    )
