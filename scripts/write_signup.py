  ...
  if (sent) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", position: "relative", zIndex: 1 }}>
        <div className="glass" style={{ width: "100%", maxWidth: "400px", padding: "44px 40px", textAlign: "center" }}>
          <div style={{ fontWeight: 700, fontSize: "18px", color: "var(--text-hero)", marginBottom: "12px" }}>Check your email</div>
          <p style={{ fontSize: "14px", color: "var(--text-secondary)" }}>We sent a confirmation link to {email}.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", position: "relative", zIndex: 1 }}>
      <div className="glass" style={{ width: "100%", maxWidth: "400px", padding: "44px 40px" }}>
        ...
        <p style={{ fontSize: "14px", color: "var(--text-secondary)", marginBottom: "36px" }}>Create your account</p>
        ...
        <p className="text-small" style={{ textAlign: "center", color: "var(--text-muted)", marginTop: "20px" }}>
          Already have an account? <Link href="/auth/signin" style={{ color: "var(--accent)", textDecoration: "none" }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
...
with open(os.path.join(BASE, 'app', 'auth', 'signup', 'page.tsx'), 'w') as f:
    f.write(signup)
print('auth/signup/page.tsx done')
